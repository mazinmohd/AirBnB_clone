...
class TestBaseModel_instantiation(unittest.TestCase):
    ...
    def test_no_args_instantiates(self):
        """Test that BaseModel instantiates with no arguments."""
    ...
    def test_args_unused(self):
        """Test that BaseModel ignores any arguments passed to it."""
        bm = BaseModel(None)
...
class TestBaseModel_save(unittest.TestCase):
    ...
    def test_two_saves(self):
        """Test that saving a BaseModel instance multiple
    ...
    def test_save_updates_file(self):
        """Test that saving a BaseModel instance updates the file.json file."""
        bm = BaseModel()
        bm.save()
...
class TestBaseModel_to_dict(unittest.TestCase):
    ...
    def test_to_dict_type(self):
        """Test that the to_dict method of BaseModel returns a dictionary."""
        bm = BaseModel()
        self.assertTrue(dict, type(bm.to_dict()))

    def test_to_dict_contains_correct_keys(self):
        """Test that the to_dict method of BaseModel
