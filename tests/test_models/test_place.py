...
class TestPlace_instantiation(unittest.TestCase):
    ...
    def test_updated_at_is_public_datetime(self):
        """
        Test that the updated_at attribute is of type datetime.
        """
    ...
    def test_two_places_unique_ids(self):
        """
        Test that two instances of Place have different ids.
        """
        pl1 = Place()
        pl2 = Place()
    ...
    def test_two_places_different_created_at(self):
        """
        Test that the created_at attribute of two
          instances of Place is different.
        """
        pl1 = Place()
        sleep(0.05)
        pl2 = Place()
    ...
    def test_two_places_different_updated_at(self):
        ...
        Test that the updated_at attribute of
          two instances of Place is different.
        """
        pl1 = Place()
        sleep(0.05)
        pl2 = Place()
    ...
    def test_args_unused(self):
        """
        Test that passing None as an argument does
          not add it to the instance's dictionary.
        """
        pl = Place(None)
    ...
    def test_instantiation_with_None_kwargs(self):
        """
        Test that instantiation of a Place object
          with None as a keyword argument raises TypeError.
        """
...
class TestPlace_save(unittest.TestCase):
    ...
    def tearDown(self):
        """Clean up after each test by removing the
          file.json and renaming tmp to file.json."""
        try:
            os.remove("file.json")
        except IOError:
            pass
    ...
    def test_two_saves(self):
        """Test that the save method updates the updated_at
          attribute and the second save is
    ...
    def test_save_updates_file(self):
        ...
        file and includes the correct Place ID."""
        pl = Place()
        pl.save()
        plid = "Place." + pl.id
...
class TestPlace_to_dict(unittest.TestCase):
    ...
    def test_to_dict_datetime_attributes_are_strs(self):
        """Test that the datetime attributes in
          the to_dict method are of type str."""
        pl = Place()
        pl_dict = pl.to_dict()
    ...
    def test_contrast_to_dict_dunder_dict(self):
        """Test that the to_dict method does not
          return the same dictionary as __dict__."""
        pl = Place()
