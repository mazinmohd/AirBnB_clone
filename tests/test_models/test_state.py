...
class TestState_instantiation(unittest.TestCase):
    ...
    def test_name_is_public_class_attribute(self):
        """Test that the name attribute is a public
          class attribute of State."""
        st = State()
    ...
    def test_two_states_unique_ids(self):
        """Test that two instances of State
          have different ids."""
        st1 = State()
        st2 = State()
    ...
    def test_args_unused(self):
        """Test that instantiating State with unused
          arguments does not add them to the instance."""
        st = State(None)
        self.assertNotIn(None, st.__dict__.values())

    def test_instantiation_with_kwargs(self):
        """Test that State can be instantiated with
          keyword arguments."""
        dt = datetime.today()
        dt_iso = dt.isoformat()
    ...
    def test_instantiation_with_None_kwargs(self):
        """Test that instantiating State with None
...
class TestState_save(unittest.TestCase):
    ...
    @classmethod
    def setUp(self):
        """Set up the test environment by renaming
    ...
    def tearDown(self):
        """Clean up the test environment by removing
          the file.json if it exists and renaming tmp
            to file.json."""
        try:
            os.remove("file.json")
        except IOError:
    ...
    def test_one_save(self):
        """Test that saving a State instance updates
    ...
    def test_two_saves(self):
        """Test that saving a State instance multiple
    ...
    def test_save_with_arg(self):
        """Test that calling save method with
          an argument raises a TypeError."""
        st = State()
        with self.assertRaises(TypeError):
            st.save(None)
    ...
    def test_save_updates_file(self):
        """Test that saving a State instance updates
          the file.json with the instance data."""
        st = State()
        st.save()
        stid = "State." + st.id
...
class TestState_to_dict(unittest.TestCase):
    ...
    def test_to_dict_type(self):
        """Test that the return value of
          to_dict method is a dictionary."""
    ...
    def test_to_dict_contains_added_attributes(self):
        """Test that to_dict method includes
        any attributes added to the State instance."""
        st = State()
    ...
    def test_contrast_to_dict_dunder_dict(self):
        """Test that the output of to_dict
          method is different from the __dict__
            attribute of State instance."""
        st = State()
